...
import { ResultsRowHeader } from '../src/js/components/ResultRowHeader.js'
import constants from '../src/js/constants';


describe('ResultsRowHeader', function() {
  ...
  it('Renders the first row',  function() {
    renderer.render(<ResultsRowHeader rowNumber={rowNum} rowPosition={rowPosition} fetchedTitles={fetchedTitles} linkCount={linkCount} fetching={fetching} maxPossibleLinks={maxPossibleLinks} />);
